...
var _stars = [],
    _glows = [];
var _mouseX = window.innerWidth * 0.5,
...
var textures = [
    PIXI.Texture.fromImage(
        "https://s3-us-west-2.amazonaws.com/s.cdpn.io/53148/neon-star.png"
    ),
    PIXI.Texture.fromImage(
        "https://s3-us-west-2.amazonaws.com/s.cdpn.io/53148/neon-star1.png"
    ),
    PIXI.Texture.fromImage(
        "https://s3-us-west-2.amazonaws.com/s.cdpn.io/53148/neon-star2.png"
    ),
    PIXI.Texture.fromImage(
        "https://s3-us-west-2.amazonaws.com/s.cdpn.io/53148/neon-star3.png"
    ),
    PIXI.Texture.fromImage(
        "https://s3-us-west-2.amazonaws.com/s.cdpn.io/53148/neon-star4.png"
    )
];
...
function createGlow() {
    var glow = new PIXI.Sprite(
        PIXI.Texture.fromImage(
            "https://s3-us-west-2.amazonaws.com/s.cdpn.io/53148/glow-star.png"
        )
    );
...
function animate() {
    ...
    for (var i = 0; i < _stars.length; i++) {
        if (_stars[i].launched) {
            ...
            _stars[i].position.x +=
                _stars[i].vx + 0.5 * Math.cos(angle) + _stars[i].vx;
            _stars[i].position.y +=
                _stars[i].vy + 0.5 * Math.sin(angle) + _stars[i].vy;
            // _stars[i].vy += 0.04;
...
function sampleCanvas() {
    ...
    textCtx.fillText("The Poole Family", width / 2, 0);
